        ...
        <div class="container">
          ...
          <div class="main-navigation">
            ...
            <ul class="menu">
              ...
              <li class="menu-item"><a href="./moviesList.html">Movie reviews</a></li>
              <li class="menu-item"><a href="./about.html">About</a></li>
              <li class="menu-item"><a href="./contact.html">Contact</a></li>
              <li class="menu-item"><a href="../user/profile.php">Profile</a></li>
            </ul>
            <!-- .menu -->
              ...
              <div class="col-md-9">
                <div class="slider">
                  <ul class="slides">
                    <li>
                      <a href="#"
                        ><img src="images/Movie.jpg" alt="Slide 1"
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img src="images/friends.jpg" alt="Slide 2"
                      /></a>
                    </li>
                    <li>
                      <a href="#"
                        ><img src="images/marriage.jpg" alt="Slide 3"
                      /></a>
                    </li>
                  </ul>
                </div>
              ...
              <div class="col-md-3">
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-12">
                    ...
                    >
                      <a href="#"
                        ><img src="images/latest2.jpg" alt="Movie 2"
                      /></a>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-2">
              <div class="widget">
                ...
                <p>
					REELSCAPE HUB is your ultimate gateway to the world of cinema. Founded in 2023 by a team of movie enthusiasts, we aim to bring the magic of the movies right to your fingertips.</p>
