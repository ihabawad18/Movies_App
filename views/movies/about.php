          ...
          <div class="page">
            ...
            <div class="row">
              ...
              <div class="col-md-3">
                ...
                <ul class="arrow">
                  <li>
                    <a href="https://www.imdb.com/board" target="_blank"
                      >IMDb Forums - Community and Forums</a
                    >
                  </li>
                  <li>
                    <a href="https://www.netflix.com" target="_blank"
                      >Netflix - Streaming Platform</a
                    >
                  </li>
                  <li>
                    <a href="https://www.amazon.com/primevideo" target="_blank"
                      >Amazon Prime Video - Streaming Platform</a
                    >
                  </li>
                  <li>
                    <a href="https://www.hulu.com" target="_blank"
                      >Hulu - Streaming Platform</a
                    >
                  </li>
                  <li>
                    <a href="https://www.rottentomatoes.com" target="_blank"
                      >Rotten Tomatoes - Reviews and Ratings</a
                    >
                  </li>
                  <li>
                    <a href="https://www.metacritic.com" target="_blank"
                      >Metacritic - Reviews and Ratings</a
                    >
                  </li>
                  <li>
                    <a href="https://www.variety.com" target="_blank"
                      >Variety - Articles and Blogs</a
                    >
                  </li>
                </ul>
              </div>
